...
class ObjectValidatorTest extends \Codeception\Test\Unit
{
    ...
    public function testIsAnObject()
    {
        ...
        $reflect = new ReflectionClass(Validator\ObjectValidator::class);
        $testMethods = [];
        ...
        $validateProxy = test::double(Validator\ObjectValidator::class, $testMethods);
        $object = new Validator\ObjectValidator();
