...
class IntegerValidatorTest extends \Codeception\Test\Unit
{
    ...
    public function testValidateInteger()
    {
        ...
        $reflect = new ReflectionClass(Validator\IntegerValidator::class);
        $testMethods = [];
        ...
        $validateProxy = test::double(Validator\IntegerValidator::class, $testMethods);
        $object = new Validator\IntegerValidator();
