...
class NumericValidatorTest extends \Codeception\Test\Unit
{
    ...
    public function testValidateIntegersAreNumeric()
    {
        ...
        $reflect = new ReflectionClass(Validator\NumericValidator::class);
        $testMethods = [];
        ...
        $validateProxy = test::double(Validator\NumericValidator::class, $testMethods);
        $object = new Validator\NumericValidator();
